...
//yiwei cfg
	...
	//printk("YF_REG: %d, %d\n", pAd->Cfg80211RegisterProbeReqFrame,  pAd->Cfg80211RegisterActionFrame);
	   ...
	   )
        {
                        ...
                        if (CFG80211OS_RxMgmt(pAd->net_dev, freq, (PUCHAR)pHeader, pRxWI->RxWIMPDUByteCnt) )
                        {
                        }
                        else
                        {
                                        DBGPRINT(RT_DEBUG_TRACE,("RtmpOsCFG80211RxMgmt FAIL!! %d\n", pHeader->FC.SubType));
                        }
...
//yiwei cfg
	...
	{
		DBGPRINT(RT_DEBUG_ERROR, ("CFG80211 EAPOL Indicate_Legacy_Packet\n"));
		Indicate_Legacy_Packet(pAd, pRxBlk, FromWhichBSSID);
                return;
	}
#endif/*RT_CFG80211_SUPPORT*/
