...
//yiwei cfg
		...
		{
			DBGPRINT(RT_DEBUG_TRACE,
					 ("CFG80211_MLME: No matching BSS, Report cfg80211_layer SM to Idle --> %d\n", pAd->Mlme.CntlMachine.CurrState));			
...
//yiwei cfg	
    ...
    if (pAd->FlgCfg80211Scanning) 
	{
	   ...
	   DBGPRINT(RT_DEBUG_TRACE, ("<--- CFG80211_MLME Disconnect in Scaning END, ORI ==> %d\n", pAd->Mlme.CntlMachine.CurrState)); 
	}
	...
	if (pAd->FlgCfg80211Connecting)
	{
		...
		DBGPRINT(RT_DEBUG_TRACE, ("<--- CFG80211_MLME Disconnect in Connecting END, ORI ==> %d\n", pAd->Mlme.CntlMachine.CurrState)); 
	}	
#endif /* RT_CFG80211_SUPPORT */	
